...
define("components/commons/dndWrapper", function() {
  "use strict";
    ...
    _renderContents() {
      ...
      if (this.state.filesAreDragged) {
        ...
        if (this.props.dragInfoText) {
          infoTextEl = <span>{this.props.dragInfoText}</span>;
        }

        return <div className="hs-dnd-wrapper__drop-area">{infoTextEl}</div>;
      }
