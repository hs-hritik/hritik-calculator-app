...
define("components/commons/skipButtonWrapper", ["gunpowder/utils/classes"], function(classes) {
  "use strict";
  ...
  return createReactClass({
    ...
    render() {
      const {className, label, onClick, disabled, dataLabels, onFocus} = this.props;
