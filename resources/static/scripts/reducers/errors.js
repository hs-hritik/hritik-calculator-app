...
define("reducers/errors", ["constants/actionTypes", "gunpowder/utils/array"], function(
  ACTION_TYPES,
  arrayUtils
) {
  "use strict";
  ...
  return (state = INITIAL_STATE, action) => {
    switch (action.type) {
      ...
      case ACTION_TYPES.REMOVE_ERROR:
        const indexOfErrorObj = arrayUtils.findIndexByKey(state, action.errorObj.type, "type");
